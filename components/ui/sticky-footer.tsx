          ...
          <div className="relative flex size-full flex-col justify-between gap-5 border-t border-white/10 px-4 py-8 md:px-12">
            ...
            <div className="mt-10 flex flex-col gap-8 md:flex-row xl:mt-0">
              ...
              <AnimatedContainer className="w-full max-w-sm min-w-2xs space-y-4">
                <div className="relative h-16 w-16 overflow-hidden rounded-full border border-white/10 bg-black/50">
                  <Image
                    src="/images/logo.png"
                ...
                <div>
                  ...
                  <p className="text-xs uppercase tracking-[0.28em] text-[#ff8b8b]/80 mb-4">
                    Casorezzo · Milano
                  </p>
                </div>
                <p className="text-stone-200/80 text-sm md:mt-0 leading-relaxed">
                ...
                <div className="space-y-3 text-sm text-stone-200/80">
                  <div className="flex items-start gap-2">
                    <MapPin size={18} className="mt-0.5 text-[#ff8b8b]" />
                    <p>{businessInfo.address}</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <PhoneCall size={18} className="mt-0.5 text-[#ff8b8b]" />
                  ...
                  <div className="flex items-start gap-2">
                    <Clock size={18} className="mt-0.5 text-[#ff8b8b]" />
                    <div>
                  ...
                  <div className="flex items-start gap-2">
                    <Mail size={18} className="mt-0.5 text-[#ff8b8b]" />
                    <div>
                      <a className="block hover:text-[#ffb3b3]" href={`mailto:${businessInfo.emails.info}`}>
                ...
                <div className="flex gap-2 pt-2">
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-stone-200/80 transition hover:bg-white/10 hover:text-[#ffb3b3]"
              ...
              {footerLinkGroups.map((group, index) => (
                ...
                >
                  <div className="mb-10 md:mb-0">
                    <h3 className="text-sm uppercase tracking-wider text-stone-50 font-medium mb-4">
                      {group.label}
                    </h3>
                    <ul className="text-stone-200/80 mt-4 space-y-3 text-sm">
            ...
            {/* Footer Bottom */}
            <div className="text-stone-400 flex flex-col items-center justify-between gap-2 border-t border-white/10 pt-6 text-sm md:flex-row">
              <p>
